...
WATSONX_API_KEY = "HDTNeC_pQNgi3NsZAedLiU4WkV3iJFzIpz0ouNmGnZ14"  # Your hardcoded API Key
WATSONX_PROJECT_ID = "0024c4e9-0283-4eb8-a0c8-12e8fe5ec51f" # Your hardcoded Project ID
...
st.set_page_config(page_title="Watsonx.ai General Chatbot with Image Upload", layout="centered")
st.title("💬 Watsonx.ai General Chatbot with Image Upload")
